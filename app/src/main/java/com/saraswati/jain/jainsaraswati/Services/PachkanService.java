...
public class PachkanService extends Service{
    long playingposition;
    long downloadingposition;
    long loadingPosition;
    private final IBinder musicBinder = new PachkanBinder();
    private MediaPlayer mediaPlayer;
    DownloadManager downloadManager;
    AudioManager.OnAudioFocusChangeListener onAudioFocusChangeListener;
    boolean wasPlaying = false;
    NotificationManagerCompat notificationManager;
    public class PachkanBinder extends Binder{
        public PachkanService getService(){
            return PachkanService.this;
        }
    }
        ...
        if(result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED){
            ...
            mediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                ...
                public void onPrepared(MediaPlayer mp) {
                    ...
                    musicPreparedIntent.setAction("PACHKAN_PREPARED");
            ...
            mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer mp) {
                    ...
                    musicCompletedIntent.setAction("PACHKAN_COMPLETED");
    ...
    private void showMusicPlayingNotification(String title){
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this,getString(R.string.music_channel_id))
                .setSmallIcon(R.drawable.ic_praying_hands_solid)
...
// notificationId is a unique int for each notification that you must define
    ...
    private void createNotificationChannel(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            String description = "This channel is to show Pachkans Notifications";
